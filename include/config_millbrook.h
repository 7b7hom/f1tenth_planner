...
struct Offline_Params {
    ...
    float d_straight = 4.0;    // max distance (m) between norm vectors along straights on the reference line
    float d_curve = 0.9;       // max norm vector spacing (m) on reference-line curves
